...
<div class="max-w-7xl mx-auto px-4">
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        @forelse($products as $product)
            <div class="bg-yellow-100 border border-gray-200 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-4 flex flex-col">
                <div class="h-32 flex justify-center items-center mb-3 ">
                    <img src="{{ $product->image }}" alt="{{ $product->name }}" class="max-h-full object-cover rounded" />
                </div>
